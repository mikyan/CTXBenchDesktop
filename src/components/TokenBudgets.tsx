...
export function TokenBudgets({ budgets }: { budgets: TokenBudgetRecord[] }) {
  const { t } = useI18n();
  const [id, setId] = useState(""); const [limit, setLimit] = useState(100000000);
