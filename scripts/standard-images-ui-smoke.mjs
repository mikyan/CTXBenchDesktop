...
try {
  ...
  for (const locale of ["en", "zh-CN"]) {
    ...
    assert.deepEqual(await page.evaluate(() => window.fixture.requests.find((row) => row.path === "/intranet/operations/standard-images").body), { dataset: "fixture", taskIds: ["task-one", "task-two"], confirmed: true });
